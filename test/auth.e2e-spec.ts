...
describe('Auth (e2e)', () => {
  ...
  it('should thow an error with invalid credentials', async () => {
    await loadFixtures('1-user.sql')
  ...
  it('should throw an error when an unauthenticated user requests a profile', () => {
    return request(app.getHttpServer())
      .get('/auth/profile')
      .expect(401)
  })

  it('should not return user\'s password with a profile', async () => {
    await loadFixtures('1-user.sql')
